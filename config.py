...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "28449420")
    API_HASH  = os.environ.get("API_HASH", "608b71c13cec20da6662327fa1fc7d35")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7083166252:AAG_jMy_OyESz6M2SJ6ATVy7wAlzA86eoho") 

    # database config
    DB_NAME = os.environ.get("DB_NAME","RealZeroDev")     
    DB_URL  = os.environ.get("DB_URL","1mongodb+srv://thezerodev:GtiCjva8tQnD1PRN@cluster0.t9gtmbv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    PORT = os.environ.get("PORT", "8080")
 
    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://graph.org/file/29a3acbbab9de5f45a5fe.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '6819408964').split()]
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'ZeroNetOfficial').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002881043369"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1002542265918"))
